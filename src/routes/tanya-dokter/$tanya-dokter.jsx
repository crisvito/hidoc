...
export function TanyaDetail() {
  ...
  return (
    <Layout>
      <div className="tanya-dokter flex flex-col items-center bg-white dark:bg-transparent my-10 shadow-lg rounded-lg">
        <div className="w-full p-10 flex flex-col gap-5">
          ...
          <div className="py-2">
            ...
            <p className="pt-10 tracking-wide leading-loose">
              {item.detailQuestion}
            </p>
          </div>
          <div className="p-3 sm:mt-0 mt-5 sm:border-2 border-0 dark:border-blue-500 rounded sm:bg-transparent bg-blue-200">
            ...
            <div className="sm:p-5 p-0 pt-0">
              ...
              <p className="tanya-content pt-10 tracking-wider leading-loose flex flex-col gap-5">
                {parse(`${item.answer}`)}
              </p>
            </div>
          </div>
