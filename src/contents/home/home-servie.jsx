...
export function HomeService() {
  return (
    <div className="mt-8 py-8 lg:px-2 sm:px-9 px-7 border-t-2 border-blue-500">
      <h1 className="sm:text-2xl text-lg text-blue-900 dark:text-blue-500 tracking-widest font-medium">
        Layanan Kesehatan
      </h1>
      <div className="mt-10">
        <div className="mt-6 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:gap-x-8">
